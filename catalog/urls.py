...
from catalog.views import HomeView, CategoryListView, ProductListView, CategoryUpdateView, CategoryDeleteView, \
    CategoryCreateView, ProductDetailView, ProductUpdateView, ProductDeleteView, ProductCreateView
