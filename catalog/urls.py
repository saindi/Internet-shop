...
urlpatterns = [
    ...
    path('api/product/', views.ProductListCreateAPIView.as_view(), name="api_products"),
    path('api/product/<int:pk>/', views.ProductRetrieveUpdateDestroyAPIView.as_view(), name="api_product"),

    path('api/category/', views.CategoryListCreateAPIView.as_view(), name="api_categories"),
    path('api/category/<int:pk>/', views.CategoryRetrieveUpdateDestroyAPIView.as_view(), name="api_category"),
]
